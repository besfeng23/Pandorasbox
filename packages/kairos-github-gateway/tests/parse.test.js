...
const parse_1 = require("../src/github/parse");
describe('github webhook parsing', () => {
    test('pull_request opened emits github.pr.opened with correct weight', () => {
        ...
        const res = (0, parse_1.parseGithubWebhook)({ eventName: 'pull_request', payload });
    ...
    test('workflow_run completed success maps to explicit workflow event type', () => {
        ...
        const res = (0, parse_1.parseGithubWebhook)({ eventName: 'workflow_run', payload });
        expect(res.events).toHaveLength(1);
