...
const SAFE_REFUSAL_BUILDER = "I can't help with creating malware, surveillance tools, or weaponization requests. Let me know if there's something else I can assist with.";
const SAFE_REFUSAL_UNIVERSE = "I can't generate content that violates consent or involves minors. Let's explore something else.";
